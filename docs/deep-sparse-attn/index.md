...
brief overview of deep sparse attention, a sparse variant of deepseeks multi latent attention, also used in glm-5 (happy belated chinese new year !) to begin , we'll start with the dsa kernel input / output definitions.
